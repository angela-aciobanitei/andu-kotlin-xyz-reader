 ...
 *
 * See: https://gist.github.com/JakeWharton/2856179
 */
class AspectRatioImageView @JvmOverloads constructor(
    ...
    companion object {
        // NOTE: These must be kept in sync with the
        // AspectRatioImageView attributes in attrs.xml.
        ...
        private const val DEFAULT_DOMINANT_MEASUREMENT =
            MEASUREMENT_WIDTH
    }
    ...
    fun setDominantMeasurement(dominantMeasurement: Int) {
        require(!(dominantMeasurement != MEASUREMENT_HEIGHT &&
